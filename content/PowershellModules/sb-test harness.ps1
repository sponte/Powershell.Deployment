...
New-SbTopic -connectionString $connectionString -name $name
Get-SbTopic -connectionString $connectionString -name $name
Test-SbTopic -connectionString $connectionString -name $name
Remove-SbTopic -connectionString $connectionString -name $name
Test-SbTopic -connectionString $connectionString -name $name